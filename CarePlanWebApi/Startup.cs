...
namespace CarePlanWebApi
{
    ...
    public class Startup
    {
        ...
        {
            services.Configure<DL_AppSettings>(Configuration.GetSection("DLAppSettings"));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "CarePlanWebApi", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "CarePlanWebApi v1"));
            }
